...
class PlateReaderApp {
    constructor() {
        ...
        this.currentDateTo = '';
        this.deduplicate = true; // Ativado por padrão
        this.timeWindow = 5;
        this.similarityThreshold = 0.6; // 60% por padrão
        this.charts = {};
        this.init();
    }
                    ...
                    if (data.deduplicated) {
                        ...
                        let statusContent = `
                            <div class="alert alert-info mb-3">
                                ...
                                <strong>Deduplicação ativa:</strong> Agrupando placas similares (≥${similarityPercent}%) 
                                em janelas de ${data.time_window} segundos e mostrando apenas a com maior confiança. 
